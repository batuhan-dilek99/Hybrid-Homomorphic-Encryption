    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::runtime_error if I/O operations failed
        */
        inline std::streamoff unsafe_load(const SEALContext &context, std::stringstream &stream)
        {
            using namespace std::placeholders;
        ...
        @throws std::runtime_error if I/O operations failed
        */
        inline std::streamoff load(const SEALContext &context, std::stringstream &stream)
        {
